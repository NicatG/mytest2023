              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="\AdminLTE-2.4.18\dist/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="\AdminLTE-2.4.18\dist/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          <a href="#">
            <i class="fa fa-dashboard"></i> <span>inventarizasiya</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li class="active"><a href="{{route('devices.index')}}"><i class="fa fa-circle-o"></i>Devices</a></li>
            <li><a href="\AdminLTE-2.4.18\index2.html"><i class="fa fa-circle-o"></i>Components</a></li>
          </ul>
        </li>
        @endrole

        <li>
          <a href="{{route('photo-upload-index')}}">
            <i class="fa fa-file-image-o"></i> <span>Photo Upload</span>
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li class="active"> <a href="{{route('allRole')}}"><i class="fa fa-circle-o"></i>Butun Rollar</a></li>
            @can('edit')
            <li><a href=""><i class="fa fa-user-plus"></i>Permession</a></li>
           @endcan
          </ul>
        </li>
