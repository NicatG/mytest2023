    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('allRole')}}"><i class="fa fa-users"></i>Bütün Rollar</a></li>
            <li><a href="\AdminLTE-2.4.18\pages/layout/boxed.html"><i class="fa fa-user-plus"></i>Yeni Rol yarat</a></li>
          
          </ul>
        </li>
        <li>
          <a href="\AdminLTE-2.4.18\pages/widgets.html">
