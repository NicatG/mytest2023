...
<div class="login-box">
  <div class="login-logo">
    <a href="/AdminLTE-2.4.18/index2.html"><b>Nijat</b>NR</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    <p class="login-box-msg">Excel Import</p>

    <form action="{{route('import')}}" method="post" enctype="multipart/form-data">
        @csrf
      <div class="form-group has-feedback">
        <input type="file" class="form-control" placeholder="file" name="excel_file" >
